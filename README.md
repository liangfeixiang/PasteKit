...
# 🧠 PasteMagic — Paste anything. We figure out the rest.
...
PasteMagic works the opposite way:

> Paste content → PasteMagic chooses the tool for you
...
PasteMagic analyzes your input and automatically activates the right component.

| What you paste   | What PasteMagic does               |
| ---------------- | --------------------------------- |
...
PasteMagic is not a tool collection.
...
```bash
git clone https://github.com/liangfeixiang/PasteMagic.git
cd PasteMagic
npm install
npm run build
```
